...
public class WebViewHostApiImpl implements WebViewHostApi {
    ...
    public static class WebViewProxy {
         ...
         */
        WebViewPlatformView createWebView(Context context) {
    ...
    public static class WebViewPlatformView extends WebView implements PlatformView, Releasable, ScrollingView {
        private ReleasableValue<WebViewClientHostApiImpl.ReleasableWebViewClient>
                currentWebViewClient;
        private ReleasableValue<DownloadListenerImpl> currentDownloadListener;

        private ReleasableValue<WebChromeClientImpl> currentWebChromeClient;
        private Map<String, ReleasableValue<JavaScriptChannel>> javaScriptInterfaces;
        ...
        public void check() {
            ...
            if (currentDownloadListener == null) {
                currentDownloadListener = new ReleasableValue<>();
            }
            if (currentWebChromeClient == null) {
                currentWebChromeClient = new ReleasableValue<>();
            }
